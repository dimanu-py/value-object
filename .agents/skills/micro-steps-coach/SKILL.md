...
description: |
  ...
  Automatically applies expand-contract pattern for risky changes.
  Forces smallest safe increments for all work types.
...
See "Quick Reference: Risky Changes" below and [REFERENCE.md](REFERENCE.md) for detailed examples.
...
**For detailed step-by-step examples, see [REFERENCE.md](REFERENCE.md).**
...
**For detailed examples of each pattern, see [REFERENCE.md](REFERENCE.md).**
...
For detailed step-by-step examples of expand-contract pattern across different contexts (database changes, API migrations, service replacements, refactorings), see [REFERENCE.md](REFERENCE.md) in this skill directory.
